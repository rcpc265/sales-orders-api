    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="orders">
                    <a href="#orders">Orders</a>
                                ...
                                <a href="#orders-GETapi-v1-orders--order_id-">Get Order details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="orders-PATCHapi-v1-orders--order_id--status">
                                <a href="#orders-PATCHapi-v1-orders--order_id--status">Update Order Status</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>API endpoints for managing sales orders.</p>
...
<p>Creates a new sales order with the provided items and calculates the total amount automatically.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="customer_email"                data-endpoint="POSTapi-v1-orders"
...
<p>Must be at least 1. Example: <code>22</code></p>
                    ...
                    <h2 id="orders-GETapi-v1-orders--order_id-">Get Order details</h2>

<p>
</p>

<p>Retrieves the details of a specific order, including its items.</p>
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="orders-PATCHapi-v1-orders--order_id--status">Update Order Status</h2>

<p>
</p>

<p>Updates the status of an order following the state machine rules.</p>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>confirmed</code></li> <li><code>shipped</code></li> <li><code>delivered</code></li> <li><code>cancelled</code></li></ul>
        </div>
        </form>
